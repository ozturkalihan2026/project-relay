...
class FlutterClientContractTests(unittest.TestCase):
    def test_client_package_declares_expected_release(self) -> None:
        ...
        self.assertIn("version: 0.8.16+72", pubspec)
        ...
        self.assertIn("${widget.mode.title} • v0.8.16", editor)
        self.assertIn("ANA MERKEZ VE MENÜ DÜZENİ • v0.8.16", main_menu)
        self.assertIn("PROJECT RELAY • v0.8.16", manual)
    ...
    def test_v060_progression_foundation_is_visible_and_temporary(self) -> None:
        ...
        self.assertIn("career-module-selection-card", career)
        self.assertGreaterEqual(career.count("width: 430"), 2)
        self.assertGreaterEqual(career.count("height: 500"), 3)
        self.assertIn("SizedBox(width: 872, child: playerEditor)", career)
    ...
    def test_v060_ui_revision_keeps_progression_visible_and_editor_compact(self) -> None:
        ...
        self.assertIn("_CircuitCreditGlyph", status)
        self.assertIn("Icons.memory_rounded", status)
        self.assertIn("minWidth: compact ? 66 : 76", status)
        self.assertIn("height: dense ? 46 : compact ? 44 : 66,", palette)
    ...
    def test_v084_profile_clan_header_and_career_preparation_contract(self) -> None:
        ...
        self.assertIn("ÇEVRİMİÇİ SAVAŞ • v0.8.16", widget_test)
        self.assertIn("ANTRENMAN • v0.8.16", widget_test)

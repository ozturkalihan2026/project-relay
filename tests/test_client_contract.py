...
class FlutterClientContractTests(unittest.TestCase):
    def test_client_package_declares_expected_release(self) -> None:
        ...
        self.assertIn("version: 0.8.18+74", pubspec)
        ...
        self.assertIn("${widget.mode.title} • v0.8.18", editor)
        self.assertIn("ANA MERKEZ VE MENÜ DÜZENİ • v0.8.18", main_menu)
        self.assertIn("PROJECT RELAY • v0.8.18", manual)
    ...
    def test_v060_progression_foundation_is_visible_and_temporary(self) -> None:
        ...
        self.assertIn("const double _careerPlayerOpponentGap = 22", career)
    ...
    def test_v084_profile_clan_header_and_career_preparation_contract(self) -> None:
        ...
        self.assertIn("ÇEVRİMİÇİ SAVAŞ • v0.8.18", widget_test)
        self.assertIn("ANTRENMAN • v0.8.18", widget_test)

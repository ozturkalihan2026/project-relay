...
class FlutterClientContractTests(unittest.TestCase):
    def test_client_package_declares_expected_release(self) -> None:
        ...
        self.assertIn("version: 0.8.15+71", pubspec)
        ...
        self.assertIn("${widget.mode.title} • v0.8.15", editor)
        self.assertIn("ANA MERKEZ VE MENÜ DÜZENİ • v0.8.15", main_menu)
        self.assertIn("PROJECT RELAY • v0.8.15", manual)
    ...
    def test_v060_progression_foundation_is_visible_and_temporary(self) -> None:
        ...
        self.assertIn("career-module-selection-card", career)
        self.assertIn("width: 430", career)
    ...
    def test_v084_profile_clan_header_and_career_preparation_contract(self) -> None:
        ...
        self.assertIn("ÇEVRİMİÇİ SAVAŞ • v0.8.15", widget_test)
        self.assertIn("ANTRENMAN • v0.8.15", widget_test)
